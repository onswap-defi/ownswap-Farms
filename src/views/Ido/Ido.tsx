          ...
          return (
            <Card >
              <CardBody>
                ...
                <Button variant="primary" fullWidth as="a" onClick={() => { if (date.toString() > singleIDO.endDate) { window.open(`/ido/${singleIDO.contractAddress}`) } else { window.open(`/ido/${singleIDO.contractAddress}`, "_self") } }} style={{ cursor: "pointer" }} >
                  {status(singleIDO)}
                </Button>
              </CardBody>
            </Card>
